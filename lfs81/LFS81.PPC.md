...
## Notes regarding building LFS 8.1 on the PowerPC:
...
The LFS book changes needed to build LFS 8.1 on the PowerPC can 
...
To apply the LFS book patch, extract a copy of the LFS8.1 book from
...
the glibc configure step.    On PowerPC32 (only) this option results
